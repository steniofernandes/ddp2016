    ...
    output$newHist <- renderPlot(
      {
        ...
        hist(x, breaks = input$nbreaks, xlab='Random Sample- Normal PDF', col='lightblue',main='Histogram', probability = TRUE)
#        hist(x2, xlab='Random Sample- Normal PDF', col='lightblue',main='Histogram', probability = TRUE)
